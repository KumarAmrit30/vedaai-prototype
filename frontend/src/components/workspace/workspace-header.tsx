  ...
  return (
    <header className="workspace-header">
      <div className="workspace-header__top">
        <div>
          <h1 className="font-display text-[24px] font-semibold tracking-tight text-[var(--text-primary)] md:text-[28px]">
            Assignments
          </h1>
          <p className="mt-1 text-[14px] text-[var(--text-secondary)]">
            Manage, organize and export AI-generated assessments.
          </p>
